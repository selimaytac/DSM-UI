...
import NavBar from '@/components/NavBar.vue'  
  ...
  export default {
    ...
    data () {
      return {
        filters: { name: [], groupname: [], grouppool: [], mcount: []},
        dialog :false,
        loader: null,
        loading: false,
        loading2: false,
        ...
        headers: [
          ...
          { text: 'Deployment Group Name', value: 'groupname', },
          { text: 'Deployment Group Pool', value: 'grouppool' },
          { text: 'Machine Count', value: 'mcount', },
