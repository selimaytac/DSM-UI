...
export default {
  ...
  data() {
    return {
      filters: { FrameworkType: [], Version: [], ComputerName: []},
      loader: null,
      loading: false,
      loading2: false,
      loading3: false,
      ...
      loaderTable: false,
      headers: [
        { text: 'Framework Type', align: 'start', sortable: false, value: 'frameworkType' },
  ...
  methods: {
    ...
    async getAllFrameworkVersions() {
      this.loaderTable = true;
      this.frameworkTypes = await customInventory.getFrameworkVersions();
      console.log(this.frameworkTypes)
      this.loaderTable = false;
    },
  },
  created() {
    this.getAllFrameworkVersions();
  },
  watch: {
    loader() {
      const l = this.loader
  ...
  computed: {
    filterProjects() {
      return this.frameworkTypes.filter((d) => {
