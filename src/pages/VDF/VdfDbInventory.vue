<template>
    <v-app id="inspire" :style="{background: $vuetify.theme.themes.dark.background}">
        ...
        <v-card color="grey">
            ...
            <v-data-table :headers="headers" :items="filterAppDbInventories" :loading="loaderTable" :items-per-page="10" :footer-props="{
...
export default {
    ...
    data() {
        return {
            filters: { server: [], appName: [], dbip: [], dbName: [], dbPort: [],},
            dialog: false,
            dialogDelete: false,
            loader: null,
            loading: false,
            ...
            headers: [
                ...
                { text: 'App. Name', value: 'appName', width: "150px", fixed: true },
                { text: 'DB IP', value: 'dbip', width: "100px", fixed: true },
                { text: 'DB Name', value: 'dbName',width: "100px", fixed: true },
                { text: 'DB Port', value: 'dbPort', width: "150px", fixed: true },
    ...
    methods: {
        ...
        columnValueList(val) {
            return this.appDbInventories.map((d) => d[val]);
        },
    },
    computed: {
        filterAppDbInventories() {
            return this.appDbInventories.filter((d) => {
