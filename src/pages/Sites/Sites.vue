...
import NavBar from '@/components/NavBar.vue'  
  ...
  export default {
    ...
    data () {
      return {
        filters: { name: [], ipadress: [], port: [], host: [], apptype: [], machname: [],poolname: [],phypath: []},
        dialog :false,
        loader: null,
        loading: false,
        loading2: false,
        ...
        headers: [
          ...
          { text: 'Machine Name', value: 'machname' },
          { text: 'Pool Name', value: 'poolname' },
          { text: 'Physical Path', value: 'phypath' },
