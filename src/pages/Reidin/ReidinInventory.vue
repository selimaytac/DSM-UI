                                    ...
                                    <v-container>
                                        <v-row>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem.serverName" label="Server Name">
                                                </v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem.os" label="OS">
                                                </v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem.ip" label="IP">
                                                </v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
                                            ...
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem.application" label="Application">
                                                </v-text-field>
                                            </v-col>
                                        </v-row>
                                    </v-container>
...
import { reidinInventoryService } from '@/services/api/reidinInventory/reidinInventory.service'
export default {
    ...
    methods: {
        ...
        editItem(item) {
            this.editedIndex = this.reidinInventory.indexOf(item)
        ...
        async deleteItemConfirm() {
            this.reidinInventory.splice(this.editedIndex, 1)
            await reidinInventoryService.deleteReidinInventory(this.editedItem.id)
            this.closeDelete()
        },
        ...
        async save() {
            if (this.editedIndex > -1) {
                ...
                await reidinInventoryService.updateReidinInventory(this.editedItem)
            } else {
                this.reidinInventory.push(this.editedItem)
                await reidinInventoryService.createReidinInventory(this.editedItem)
            }
            this.close()
        },
        ExportExcel() {
            if (this.search.length > 0) {
                reidinInventoryService.getExportSearchList(this.search);
            } else {
