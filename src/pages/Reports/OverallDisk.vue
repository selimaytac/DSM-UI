...
import NavBar from '@/components/NavBar.vue'  
  ...
  export default {
    ...
    data () {
      return {
        filters: { name: [], servername: [], lastdate: [], volume: [], disk: [],userdisk: [],freedisk: [], responsible: []},
        dialog :false,
        loader: null,
        loading: false,
        loading2: false,
        ...
        headers: [
          ...
          { text: 'Disk Capacity', value: 'disk' },
          { text: 'User Disk Space', value: 'userdisk' },
          { text: 'Free Disk Space', value: 'freedisk' },
