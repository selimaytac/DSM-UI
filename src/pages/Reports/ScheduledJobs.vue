...
import NavBar from '@/components/NavBar.vue'  
  ...
  export default {
    ...
    data () {
      return {
        filters: { name: [], owner: [], htype: [], hname: [], repeat: [],jobname: []},
        dialog :false,
        loader: null,
        loading: false,
        loading2: false,
        ...
        search: '',
        headers: [
          { text: 'Job Description',align: 'start',sortable: false,value: 'name'},
            { text: 'Owner', value: 'owner', },
          { text: 'Host Type', value: 'htype' },
          { text: 'Host Name', value: 'hname' },
          { text: 'Repeat Time', value: 'repeat' },
